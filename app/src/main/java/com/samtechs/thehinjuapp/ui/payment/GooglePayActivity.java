...
import com.samtechs.thehinjuapp.databinding.ActivityGooglePayBinding;
import com.samtechs.thehinjuapp.ui.payment.viewmodel.GooglePaytViewModel;
...
public class GooglePayActivity extends AppCompatActivity {
    ...
    private GooglePaytViewModel model;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = new ViewModelProvider(this).get(GooglePaytViewModel.class);

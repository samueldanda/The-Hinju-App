package com.samtechs.thehinjuapp.ui.payment.viewmodel;
...
import com.samtechs.thehinjuapp.ui.payment.util.PaymentsUtil;

public class GooglePaytViewModel extends AndroidViewModel {
    ...
    public GooglePaytViewModel(@NonNull Application application) {
        super(application);
